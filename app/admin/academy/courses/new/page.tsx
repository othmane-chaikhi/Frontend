...
export default function CreateCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSaving(true);
      const response = await academyAPI.courses.create(formData);
      alert('Cours créé avec succès !');
      router.push(`/admin/academy/courses/${response.data.id}/edit`);
    } catch (error: any) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Créez un nouveau cours pour l'Academy
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="python-pour-debutants"
              required
            />
            <p className="mt-1 text-sm text-gray-500">
              Généré automatiquement depuis le titre, mais modifiable
            </p>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              <label htmlFor="is_active" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                Cours actif (visible pour les utilisateurs)
              </label>
            </div>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="is_featured" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                Cours en vedette (affiché en premier)
              </label>
            </div>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <p className="text-sm text-blue-800 dark:text-blue-300">
              💡 <strong>Astuce :</strong> Après la création, vous pourrez ajouter des vidéos et exercices à ce cours sur la page d'édition.
            </p>
          </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t dark:border-gray-700">
            ...
            >
              <div className="flex items-center gap-2">
                <FiSave />
                {saving ? 'Création...' : 'Créer et Ajouter des Items'}
              </div>
            </button>
          </div>
        </form>
